...
export const BaseHeroWrapper = ({ children, className, image, ...rest }: BaseHeroWrapperProps) => {
  return (
    <div  className={cn("relative h-fit mx-auto px-6 pt-32 pb-12 sm:pb-16 md:pb-18 lg:pb-20 xl:pb-40 lg:pt-56", className)} {...rest}>
      ...
      <figure className="absolute inset-0 -z-20 to-transparent">
        <Image 
          src={
            image.src ?? "https://images.pexels.com/photos/1850595/pexels-photo-1850595.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          }
          fill
